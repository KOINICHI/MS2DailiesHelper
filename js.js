...
Main.controller('ArikkariHelperCtrl', ['$scope', function($scope) {
	...
	$scope.Housing = ['블루/핑크 스포트라이트, 반짝 미러볼 작동하기','다이나믹 러닝머신 체험하기', '럭셔리 새면대에서 세수하기', '디럭스 샤워 부스에서 샤워하기', '낚시 의자에 앉아보기', '쇼케이스 냉장고 살펴보기', '주황 콤팩트 냉장고 살펴보기', '하얀 콤팩트 냉장고 살펴보기', '하얀 미니 냉장고 살펴보기', '레트로 TV 시청하기', '블랙 슬림 TV 시청하기', '화이트 슬림 TV 시청하기', '야옹 캣타워에서 고양이와 놀기', '사이클론 실내 자전거 체험하기'];
	$scope.HousingMap = null;
	$scope.Using = ['황금사과 먹어보기','달콤한 나뭇잎 먹어보기','쉐도우 DNA 먹어보기','빠빠 가루 먹어보기','빠빠 열매 따기/구해오기','뚜삐뚜 젤리 먹어보기','요정수 먹어보기','이블아이의 눈 먹어보기'];
	$scope.UsingMap = ['나무꾼의 언덕','엘보의 통나무 굴','쉐도우 게이트','바로타 무역항','카브리엄 분지','우드버리','흰 바위산','개미굴 광장'];
	$scope.Storybook = ['튜닝 모터스 : 지프 에디션','블록 골렘 카탈로그','Ms DECOR : 베드 컬렉션','인테리어 Vol. #','Beauty Dr.Jenco & Dicson'];
	$scope.StorybookMap = ['트라이아-홍보 사원 고든','골두스 펜트 하우스','골두스 펜트 하우스','트라이아 도서관','트라이아 도서관'];
